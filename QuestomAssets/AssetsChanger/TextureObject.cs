...
{
    public abstract class TextureObject : AssetsObject, IHaveName
    {
        public TextureObject(IObjectInfo<AssetsObject> objectInfo, AssetsReader reader) : base(objectInfo)
        {
            Parse(reader);
        }

        public TextureObject(IObjectInfo<AssetsObject> objectInfo) : base(objectInfo)
        { }

        public TextureObject(AssetsFile assetsFile, int classID) : base(assetsFile, classID)
        { }
